<template>
  <div id="demo-vue-native" ref="rect">
    <div>
      <!-- 前端依赖版本 -->
      <div v-if="Vue.Native.version" class="native-block">
        <label class="vue-native-title">Vue.Native.version</label>
        <p>{{ Vue.Native.version }}</p>
      </div>
...
<!--        <label class="vue-native-title">Vue.Native.SDKVersion</label>-->
<!--        <p>{{ Vue.Native.SDKVersion}}</p>-->
<!--      </div>-->
...
<!--      <div v-if="Vue.Native.Dimensions.screen.statusBarHeight" class="native-block">-->
<!--        <label class="vue-native-title">Vue.Native.Dimensions.screen.bottomBarHeight</label>-->
<!--        <p>{{ Vue.Native.Dimensions.screen.bottomBarHeight }}</p>-->
<!--      </div>-->

      <!-- 设备模式 -->
      <div v-if="Vue.Native.DeviceModel" class="native-block">
        <label class="vue-native-title">Vue.Native.DeviceModel</label>
        <p>{{ Vue.Native.DeviceModel }}</p>
      </div>

      <div class="native-block">
        <label class="vue-native-title">Vue.Native.PixelRatio</label>
        <p>{{ Vue.Native.PixelRatio }}</p>
      </div>
      ...
      <div v-if="app" class="native-block">
        <label class="vue-native-title">App.$options.$superProps 终端传来的启动参数</label>
