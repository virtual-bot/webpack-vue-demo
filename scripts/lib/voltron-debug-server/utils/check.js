...
function getFrameworkVersion(opts) {
  ...
  try {
    ...
    if (!framework) {
      ...
      switch (true) {
        case dependencyList.includes('@tencent/voltron-react-qb'):
          framework = 'voltron-react-qb';
          break;
        case dependencyList.includes('@hippy/react'):
        case dependencyList.includes('@tencent/voltron-react'):
        case dependencyList.includes('voltron-react'):
          framework = 'voltron-react';
          break;
        case dependencyList.includes('@hippy/vue'):
        case dependencyList.includes('@tencent/voltron-vue'):
        case dependencyList.includes('voltron-vue'):
          framework = 'voltron-vue';
          break;
        default:
          // pass
      }
